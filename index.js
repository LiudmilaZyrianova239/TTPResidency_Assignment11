...
const {Student, Campus}= require('./association');
...
router.get("/campus/withstudents/:campusID", (req, res) => {
  ...
  Campus.findOne({
    ...
    .then(campus => {
      console.log(`It's students of Campus with ID = ${campusID}:`);
      campus.getStudents({raw: true})
      .then (input => {
        console.log(input);
        res.json(input);
      })
...
router.get("/campus/:campusID", (req, res) => {
  ...
  .then(input => {
    console.log(`One Campus with ID = ${campusID}`);
    console.log(input);
    res.json(input);
  })
...
router.get("/student/:studentID", (req, res) => {
  ...
  .then(input => {
    console.log(`One Student with ID = ${studentID}`);
    console.log(input);
    res.json(input);
  })
});
